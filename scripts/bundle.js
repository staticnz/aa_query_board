            ...
            var QueryBasedBoardRepository = function() {
                ...
                QueryBasedBoardRepository.prototype.getData = function(queryId, queryName, queryPath) {
                    ...
                    return this.witClient.queryById(queryId, this.context.project.id, null, null).then(function(queryResult) {
                        ...
                        var wiFields = ["System.Title", "System.AssignedTo", "System.State", "System.WorkItemType", "Microsoft.VSTS.Common.BusinessValue", "System.AreaPath"];
                        var batchSize = 200;
                        var batchArray = [];
                        var batchStartPos = 0;
        ...
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(require, exports) {
            ...
            var BoardWorkItemModel = function() {
                function BoardWorkItemModel(workItem, parentId) {
                    ...
                    this.value = workItem.fields["Microsoft.VSTS.Common.BusinessValue"];
                    this.area = workItem.fields["System.AreaPath"];
            ...
            var BoardCard = function(_super) {
                ...
                BoardCard.prototype.render = function() {
                    return React.createElement("div", {
                        ...
                        role: "button",
                        onClick: this.onOpenWorkItem
                    }, `${this.props.workItem.title} (${this.props.workItem.value})`))),
                    React.createElement("div", {className: "container-areapath"},React.createElement("span", {className: "area"}, `Team: ${this.props.workItem.area}`)), React.createElement("div", {
                        className: "container witExtra"
                    }, React.createElement("div", {
                        className: "field-container onTileEditDiv non-combo-behavior ellipsis identity"
                    }, React.createElement("div", {
